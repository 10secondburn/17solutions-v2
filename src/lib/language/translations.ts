...
const translations = {
  ...
  'module.validieren_05': { de: 'Protagonisten-Search', en: 'Protagonist Search' },
  'module.validieren_06': { de: 'Ereignisse', en: 'Events/Timing' },
  'module.create_07': { de: 'Sprungbretter', en: 'Springboards' },
  'module.create_08': { de: 'Partnerschaften', en: 'Partnerships' },
  'module.create_08b': { de: 'Zielpublikum', en: 'Audience Design' },
